...
namespace TesteClient.Migrations
{
    ...
    [Migration("20230108172613_Ajour du modele adr")]
    partial class Ajourdumodeleadr
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AdresseApplicationUser", b =>
                {
                    b.Property<string>("AdressesId")
                        .HasColumnType("nvarchar(450)");

                    b.Property<string>("ApplicationUsersId")
                        .HasColumnType("nvarchar(450)");

                    b.HasKey("AdressesId", "ApplicationUsersId");

                    b.HasIndex("ApplicationUsersId");

                    b.ToTable("AdresseApplicationUser");
                });
            ...
            modelBuilder.Entity("AdresseApplicationUser", b =>
                {
                    b.HasOne("TesteClient.Models.Adresse", null)
                        .WithMany()
